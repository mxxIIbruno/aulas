...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lneName = QLineEdit(self.centralwidget)
        self.lneName.setObjectName(u"lneName")
        self.lneName.setFont(font1)

        self.gridLayout_2.addWidget(self.lneName, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lneName.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Digite seu nome", None))
